...
public class Snipe {
    ...
    public static final int cooltime = 600;
    ...
    public static final double atkCoeffi =1.5;
            ...
            if(targeted){
                ...
                for(double i=0; i<=(float) distance ;i+=0.1){
                    ...
                    Vec3d pos2 = pos.add(playerLookVec.multiply(Math.min(distance,i+1.5)));
                        world.spawnParticles(new DustParticleEffect(new Vector3f(1.0f, 0.3f, 0.3f),0.4f), pos.x, pos.y, pos.z, 5, 0, 0, 0, 0);
                        world.spawnParticles(
