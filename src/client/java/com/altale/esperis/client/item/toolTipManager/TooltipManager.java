...
public class TooltipManager {
    public TextColor getStatColor(TooltipStatType ttStatType) {
        TextColor statColor;
        switch (ttStatType) {
            ...
            case FinalDamagePercent -> statColor = TextColor.fromRgb(0xFFFFFF);//하얀색
    ...
    public Text makeStatText(TooltipStatType ttStatType, TooltipTextInfoType textInfoType) {
